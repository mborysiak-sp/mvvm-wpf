...
namespace DatabaseClient.EntityData
{
    ...
    [MetadataTypeAttribute(typeof(bearing.BearingMetadata))]
    public partial class bearing : BaseEntity
    {
        ...
        public void MetaSetUp()
        {
            ...
            TypeDescriptor.AddProviderTransparent(
                new AssociatedMetadataTypeTypeDescriptionProvider(typeof(bearing),
                typeof(BearingMetadata)),
                typeof(bearing));
        }
        internal sealed class BearingMetadata
        {
