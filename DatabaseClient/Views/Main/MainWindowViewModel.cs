    ...
    public class MainWindowViewModel : NotifyUIBase
    {
        ...
        public MainWindowViewModel()
        {
            ObservableCollection<ViewVM> views = new ObservableCollection<ViewVM>
            {
                ...
                new ViewVM { ViewDisplay="Złom wrzeciona", ViewType = typeof(ScrappedSpindlesView), ViewModelType = typeof(ScrappedSpindlesViewModel)},
                new ViewVM { ViewDisplay="Złom wytacaczadła", ViewType = typeof(ScrappedBoringBarsView), ViewModelType = typeof(ScrappedBoringBarsViewModel)},
                new ViewVM { ViewDisplay="Dokumenty", ViewType = typeof(AllDocumentsView), ViewModelType = typeof(AllDocumentsViewModel)},
                new ViewVM { ViewDisplay="Dokumenty Wytaczadła", ViewType = typeof(DocumentBoringBarView), ViewModelType = typeof(DocumentBoringBarViewModel)},
                new ViewVM { ViewDisplay="Documenty Wrzeciona", ViewType = typeof(DocumentSpindleView), ViewModelType = typeof(DocumentSpindleViewModel)}
            };
            Views = views;
            ...
            {
                new CommandVM{ CommandDisplay="Nowy", IconGeometry=Application.Current.Resources["InsertIcon"] as Geometry , Message=new CommandMessage{ Command =CommandType.Insert}},
